...
function About() {
	...
	const about = (
		<div className="about-body">
			After <span className="highlight-text"> {yearsOfExperience} years</span>{" "}
			of software developer experience and 3 years at{" "}
			...
			<span className="highlight-text">startup</span> and have worked on many
			different projects.
		</div>
	);
