          ...
          <FadeIn duration={800}>
            <div className="mt-12 text-textAlternative text-sm space-y-3 break-words">
              ...
              <p>
                ...
                The backend for this setup spans between two different servers in my apartment. The first being a raspberry pi 500, and the second being my personal computer. All LLM summarization/embedding/entity-extraction is offloaded to my personal computer running a Nvidia 2080 Super.
              </p>
            </div>
          </FadeIn>
        </div>
